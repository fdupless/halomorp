...
EBins=[Emin,20,35,Emax] #Energy Bins to color code the photons. ( # E bins = len(Ebins)-1 )
...
hel=1.0 #helicty of the magnetic field for case {4,5 and 6}. It takes the value 1 or -1.
...
Lcname='sim_data/Lcutoff_heleq1.npy'      #file name of the cutoff/lattice spacing length in Mpc
